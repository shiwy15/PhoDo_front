        ...
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                ...
                <form className="mt-6" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-2">
                        <label htmlFor="password" className="block text-lg font-semibold text-gray-800">Password</label>
                    ...
                    <a href="/forgotpw" className="text-md mt-2 text-purple-600 hover:underline">Forget Password?</a>
                    <div className="mt-6">
                        <button type="submit" className="w-full px-4 text-2xl py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600">Login</button>
                    </div>
                </form>
                ...
                <p className="mt-8 text-lg font-light text-center text-gray-700">
                    ...
                    <a href="/signup" className="text-lg text-purple-600 hover:underline">Sign up</a>
                </p>
            </div>
        </div>
    );
