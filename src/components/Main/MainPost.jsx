    ...
    >
      ...
      <Grid container>
        <Grid item md={10}>
          ...
          >
            <Typography component="h1" variant="h3" color="inherit" gutterBottom sx={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>
              {post.title}
            </Typography>
            ...
            <Button variant="outlined" href="/editor" sx={{color: 'white', borderColor: 'white', borderRadius: '50px'}}>
            {post.linkText}
            </Button>
