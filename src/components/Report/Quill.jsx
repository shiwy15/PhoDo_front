...
const QuillEditor = () => {
    ...
    <br>
    <p> 거실 : 거실은 가족이 함께 모여 대화하고, 휴식을 취하는 공간입니다. 이에 걸맞게 벽지는 흐린 초록색으로, 바닥은 헤링본 패턴의 진한 갈색으로 결정하였습니다. 이러한 색조는 평온하고 따뜻한 분위기를 더해줄 것입니다. 또한, 편안한 환경을 위해 하얀색 소파를 구매할 예정이며, 식물 그림 액자를 최소 3개 이상 구매하여 신선함을 더할 예정입니다. </p>
    <p> 침실 : 침실은 가장 개인적인 공간으로, 편안하고 쾌적한 환경이 필요합니다. 필요한 가구로는 침대, 옷장, 테이블, 의자, 선반, 조명이 있으며, 이에 대한 예산은 300만원으로 설정하였습니다. </p>
    <p> 화장실 : 화장실은 깨끗하고 신선한 이미지를 유지하는 것이 중요합니다. 예산 한도는 600만원으로 설정하였으며, 깔끔함을 강조하기 위해 타일은 하얀색으로 결정하였습니다.</p>
    <br>
    ...
    const exportAsPDF = () => {
        ...
        html2canvas(editor, {scale : 2}).then((canvas) => {
            ...
            pdf.addImage(imgData, 'PNG', 10, 8, pdfWidth, pdfHeight);
            pdf.line(15, 8, 195, 8);
...
<div >
    ...
    <ReactQuill 
        ...
        modules={modules}
        ref={editorRef}
        style={{ height: "70vh", borderColor: 'white'}}
    />
</div>
