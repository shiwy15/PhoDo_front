...
const Projectenterbar = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-70 pt-20 border-b border-gray-300 overflow-hidden w-full">
    ...
    <button type="submit" className="ml-4 bg-gray-800 hover:bg-purple-200 text-gray-800 font-bold py-2 px-4 border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40e">
        검색
    </button>
</form>
